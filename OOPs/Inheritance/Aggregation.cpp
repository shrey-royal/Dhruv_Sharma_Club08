...
public:
    ...
    void displayInfo() {
        cout << "Name: " << name << ", Account Number: " << accountNumber << ", Balance: Rs." << balance << endl;
    }
};
...
private:
    string bankName;
    Customer* customers; //Array of customer pointers
    int capacity;
    int size;
...
int main() {
    Bank sbi("State Bank of India", 5);

    Customer c1("Dhruv", 1001, 5000);
    Customer c2("Samir", 1011, 7000);
